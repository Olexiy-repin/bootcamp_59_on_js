...
//   const filteredCarsByPrice = allCars.filter((el, idx, arr) => {
...
*/
// Повна версія
// const getCarsWithType = (allCars, carType) => {
//   return allCars.filter((el, idx, arr) => {
//     return el.type === carType;
//   });
// };
...
// Скорочена версія
// const getCarsWithType = (allCars, carType) => allCars.filter(el => el.type === carType);
